...
const questions = [
  {
    ...
    a: "Sports Media Inc. as a Software Engineering Intern. He built a token based authentication system in Python and Java that boosted login success by 30 percent, cut page load times by 1.2 seconds, and shipped features to over 5,000 accounts."
  },
  {
    q: "What is Anish working on right now?",
    a: "He is co founder of KarvBill, an AI tool that audits medical bills and surfaces pricing errors. He is also recruiting for summer 2026 software engineering internships and grinding LeetCode in Python and Java."
  },
  {
  ...
  },
  {
    ...
    a: "Football, chess, and boxing. Plenty of NBA 2K, Rocket League, and Fortnite. Heavy fan of How I Met Your Mother, Breaking Bad, and House M.D."
  },
  {
    q: "Has he done research?",
    a: "Yes. A year at NC A and T State University researching CAN bus cyberattack detection. Built and evaluated 5 ML models, hit 95 percent accuracy, and co authored a peer reviewed paper at the 2024 icABCD Conference."
  },
  {
    q: "How can I reach Anish?",
    a: "Email is fastest at abpatel1@unc.edu. He is also on LinkedIn and GitHub."
  }
];
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-[#4B9CD3] hover:bg-[#5FAEE0] flex items-center justify-center text-white shadow-lg transition-colors"
      >
